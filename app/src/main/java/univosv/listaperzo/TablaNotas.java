...
/**
 * Created by adolfo on 05/01/2018.
 */
...
public class TablaNotas {
     ...
     */
    public TablaNotas(Activity actividad, TableLayout tabla)
    {
    ...
    public void agregarCabecera(int recursocabecera)
    {
        ...
        for(int i = 0; i < arraycabecera.length; i++)
        {
            ...
            texto.setBackgroundResource(R.drawable.post_border_background);
            texto.setLayoutParams(layoutCelda);
            texto.setTextSize(25);
            texto.setTextColor(R.color.colorPrimaryDark);
